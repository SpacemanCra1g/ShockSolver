...
// static double RelSpeed(double a, double b) { return (a - b) / (1 - a * b); }
...
// static double RarefactionVx(double p, RarefactionParams *params) {
...
// static double ux(double xi, double S, double press, double A, double sign) {
...
// static double SampleRarefactionWave(double pressure, void *Parms) {
...
// static double Taub(double hA, double rho, double p, double pres) {
...
// static double J_sqr(double pres1, double pres2, double hA, double hB) {
//   double val;
...
// static double ShockSpeed(double lor, double r, double v, double J, int sign) {
//   double D = r * lor;
//   return (D * D * v + (double)sign * J * sqrt(J * J + D * D * (1.0 - v * v))) /
//          (D * D + J * J);
// }

// static double ShockVx(double p, ShockParams *params) {
//   double hA = params->h;
...
// static double DoubleRarefactionPstar(double p, void *param) {
...
// static double RareShockPstar(double p, void *param) {
...
// static double ShockShockPstar(double p, void *param) {
